<?php
	...
	function custom_scripts() {
		if(is_admin()){
			add_action( 'admin_print_scripts', 'output_admin_scripts' );
			add_action( 'admin_print_styles', 'output_admin_styles' );
			add_action( 'admin_footer', 'load_colour_picker' );
		} else {
			add_action( 'wp_print_scripts', 'output_scripts' );
			add_action( 'wp_print_styles', 'output_styles' );
